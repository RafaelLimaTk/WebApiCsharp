...
public class DbInitializer : IDbInitializer 
{
    ...
    public void Initialize()
    {
        ...
        ApplicationUser admin = new ApplicationUser()
        {
            ...
            Email = "rafael-admin@erudio.com",
            EmailConfirmed = true,
            PhoneNumber = "+55 (75) 12345-67891",
            FirstName = "Rafael",
            LastName = "Admin"
        };

        _user.CreateAsync(admin, "Rafael123456$").GetAwaiter().GetResult();
        ...
        ApplicationUser client = new ApplicationUser()
        {
            ...
            Email = "rafael-client@erudio.com",
            EmailConfirmed = true,
            PhoneNumber = "+55 (75) 12345-67891",
            FirstName = "Rafael",
            LastName = "Client"
        ...
        _user.CreateAsync(client, "Rafael123456$").GetAwaiter().GetResult();
